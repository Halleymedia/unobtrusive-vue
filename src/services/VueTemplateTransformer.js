...
const expressions = [componentName, renderIf, renderFor, inputValue, eventHandlers, builtinAttributes, componentDataAttributesExpressions, customAttributesExpressions, customAttributesLiterals];
